  ...
  _createClass(Portal, [{
    ...
    value: function closePortal() {
      ...
      var resetPortalState = function resetPortalState() {
        if (_this2.node) {
          ...
          var target = _this2.props.target ? document.getElementById(_this2.props.target) : document.body;
          target.removeChild(_this2.node);
        }
        _this2.portal = null;
        _this2.node = null;
        if (isUnmounted !== true) {
    ...
    value: function renderPortal(props) {
      if (!this.node) {
        ...
        var target = props.target ? document.getElementById(props.target) : document.body;
