...
export default class Portal extends React.Component {
  ...
  closePortal(isUnmounted = false) {
    const resetPortalState = () => {
      if (this.node) {
        ...
        const target = this.props.target ? document.getElementById(this.props.target) : document.body;
  ...
  renderPortal(props) {
    if (!this.node) {
      ...
      const target = props.target ? document.getElementById(props.target) : document.body;
